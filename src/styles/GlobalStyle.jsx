...
export const RATING_BADGE_GREEN_BOX_SHADOW =
  "0px 0px 0px 1px #11481e, 0px 1px 0px 2px #0d3817, 0px 3px 3px 1px #0003";
...
const GlobalStyle = createGlobalStyle`
  ...
  .rating_details {
    z-index: 1 !important;
    box-shadow: ${RATING_BADGE_GREEN_BOX_SHADOW} !important;
  }
